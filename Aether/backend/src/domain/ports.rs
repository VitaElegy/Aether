...
pub trait ArticleRepository: Send + Sync {
    ...
    async fn get_diff(&self, id: &Uuid, v1: &str, v2: &str)
...
pub trait CommentRepository: Send + Sync {
    ...
    async fn get_comments_batch(
        &self,
        target_ids: Vec<Uuid>,
    ) -> Result<std::collections::HashMap<Uuid, usize>, RepositoryError>;
}
...
pub trait DraftRepository: Send + Sync {
    async fn save_draft(
        &self,
        draft: crate::domain::models::UserDraft,
    ) -> Result<(), RepositoryError>;
    async fn get_draft(
        &self,
        user_id: &UserId,
    ) -> Result<Option<crate::domain::models::UserDraft>, RepositoryError>;
...
pub trait PermissionRepository: Send + Sync {
    ...
    async fn get_direct_relations(
        &self,
        subject_id: Uuid,
    ) -> Result<Vec<(Uuid, String, String)>, RepositoryError>; // Returns (EntityId, EntityType, Relation)
}
...
pub trait GraphRepository: Send + Sync {
    ...
    async fn get_tree(
        &self,
        kb_id: &Uuid,
    ) -> Result<Vec<crate::domain::models::GraphNode>, RepositoryError>;
    async fn find_by_id(
        &self,
        id: &Uuid,
    ) -> Result<Option<crate::domain::models::GraphNode>, RepositoryError>;
    async fn delete(&self, id: &Uuid) -> Result<(), RepositoryError>;
}
...
pub trait VrkbRepository: Send + Sync {
    ...
    async fn create_project(
        &self,
        project: crate::domain::models::VrkbProject,
    ) -> Result<Uuid, RepositoryError>;
    async fn get_project(
        &self,
        id: &Uuid,
    ) -> Result<Option<crate::domain::models::VrkbProject>, RepositoryError>;
    async fn list_projects(
        &self,
    ) -> Result<Vec<crate::domain::models::VrkbProject>, RepositoryError>;

    // Section
    async fn create_section(
        &self,
        section: crate::domain::models::VrkbSection,
    ) -> Result<Uuid, RepositoryError>;
    async fn list_sections(
        &self,
        project_id: &Uuid,
    ) -> Result<Vec<crate::domain::models::VrkbSection>, RepositoryError>;

    // Finding
    async fn create_finding(
        &self,
        finding: crate::domain::models::VrkbFinding,
    ) -> Result<Uuid, RepositoryError>;
    async fn get_finding(
        &self,
        id: &Uuid,
    ) -> Result<Option<crate::domain::models::VrkbFinding>, RepositoryError>;
    ...
    async fn list_project_assets(
        &self,
        project_id: &Uuid,
    ) -> Result<Vec<crate::domain::models::VrkbAsset>, RepositoryError>;
    async fn delete_asset(&self, id: &Uuid) -> Result<(), RepositoryError>;

    // Members
    async fn add_member(
        &self,
        member: crate::domain::models::VrkbMember,
    ) -> Result<(), RepositoryError>;
    async fn remove_member(&self, project_id: &Uuid, user_id: &Uuid)
        -> Result<(), RepositoryError>;
    async fn list_members(
        &self,
        project_id: &Uuid,
    ) -> Result<Vec<crate::domain::models::VrkbMember>, RepositoryError>;
    ...
    async fn get_specs(
        &self,
        project_id: &Uuid,
    ) -> Result<Vec<crate::domain::models::VrkbSpec>, RepositoryError>;
    async fn save_spec(
        &self,
        spec: crate::domain::models::VrkbSpec,
    ) -> Result<Uuid, RepositoryError>;

    // Docs
    async fn create_doc(
        &self,
        doc: crate::domain::models::VrkbDoc,
    ) -> Result<Uuid, RepositoryError>;
    async fn get_doc(
        &self,
        id: &Uuid,
    ) -> Result<Option<crate::domain::models::VrkbDoc>, RepositoryError>;
    ...
    async fn list_docs(
        &self,
        project_id: &Uuid,
    ) -> Result<Vec<crate::domain::models::VrkbDoc>, RepositoryError>;
