    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-lg overflow-hidden border border-gray-200 dark:border-gray-700">
      ...
      <div class="p-6">
        ...
        <div v-else-if="step === 'completed'" class="text-center py-6">
          ...
          <p class="text-gray-500 mb-3">Your portability package has been generated successfully.</p>
          <p class="text-xs text-emerald-700 bg-emerald-50 dark:bg-emerald-900/20 rounded-md px-3 py-2 mb-6">
            This ZIP includes both portability files and an embedded restorable snapshot for Backup Manager.
          </p>
